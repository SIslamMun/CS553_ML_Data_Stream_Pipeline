...
_YOLO_DEFAULT_ANCHORS = [
    torch.Tensor([[12,16], [19,36], [40,28]]),
    torch.Tensor([[36,75], [76,55], [72,146]]),
    torch.Tensor([[142,110], [192,243], [459,401]]),
]
...
def get_yolo_loader_and_saver(
    path: str, image_size: Tuple[int, int] = (640, 640), args: Any = None
    ...
    return YoloImageLoader(path, image_size), False
...
def load_image(
    img: Union[str, numpy.ndarray], image_size: Tuple[int, int] = (416, 416)
